 ...
 */
final class Version20211217093852 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_kontrahent (order_id INT NOT NULL, kontrahent_id INT NOT NULL, INDEX IDX_D9EBB57C8D9F6D38 (order_id), INDEX IDX_D9EBB57C38A37D02 (kontrahent_id), PRIMARY KEY(order_id, kontrahent_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
